											...
											<div class="table100 ver4 m-b-110">
												...
												<div class="table100-body js-pscroll">
													<table>
														<tbody>
	                                <?php 
	                                		$sql="SELECT * FROM orderdetail JOIN despatcher ON orderdetail.DespatcherID=despatcher.DespatcherID JOIN customer ON customer.CustID=orderdetail.CustID WHERE despatcher.Username='".$_SESSION['user']."' AND (orderdetail.Status ='Prepared')";
	                                		...
	                                		while ($row = $result->fetch_assoc()) {
		                                		...
		                                		<tr>
		                                			...
		                                			<td class='cell100 column8'><button class='update' type=submit name=updatedeliver value=".$row['OrderID'].">Update</button></td>
		                                			</form>
		                                		</tr>
		                                		";	
	                                		}	
