...
{
        if(!empty($_POST['f'])&&!empty($_POST['resSearch']))
        {
            $food='%'.$_POST['f'].'%';
            $res='%'.$_POST['resSearch'].'%';

            $sql = "SELECT * FROM item JOIN restaurant ON item.ResID=restaurant.ResID WHERE item.itemName LIKE '".$food."' AND restaurant.Name LIKE'".$res."'";
            $query = $conn->query($sql);
        }
        elseif (!empty($_POST['f'])) {
           $food='%'.$_POST['f'].'%';
           $sql = "SELECT * FROM item JOIN restaurant ON item.ResID=restaurant.ResID WHERE item.itemName LIKE '".$food."'";
            $query = $conn->query($sql);
        }
        elseif (!empty($_POST['resSearch'])) {
            $res='%'.$_POST['resSearch'].'%';
            $sql = "SELECT * FROM item JOIN restaurant ON item.ResID=restaurant.ResID WHERE restaurant.name LIKE '".$res."'";
            $query = $conn->query($sql);
        }
        else
        {
