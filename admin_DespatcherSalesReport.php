...
?>
 <?php   
 $query = "SELECT a.DespatcherID, b.DesName, count(a.DespatcherID) as number FROM orderdetail a INNER JOIN despatcher b ON a.DespatcherID=b.DespatcherID GROUP BY a.DespatcherID";  
    ...
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["DesName"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: 'Percentage of Despatcher Sales',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
        ...
        <div class="slider__area slider--one">
            ...
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Percentage of Despatcher Sales Report</h2>
                </div>
                <div class="card-body">
