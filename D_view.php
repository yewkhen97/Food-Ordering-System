                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Detail of despatcher</h2>
                            </div>
                        </div>
                    </div>
                </div>
													...
													<table>
														<thead>
															...
															<tr class="row100 head">
																...
																<th class="cell100 column4">Vehicle</th>
	                                ...
	                                <?php 
	                                		...
	                                		while ($row = $result->fetch_assoc()) {
		                                		...
		                                		<tr class=row100 body>
		                                			...
		                                			<td class='cell100 column4'>".$row["Password"]."</td>
		                                			<td class='cell100 column5'>".$row["Vehicle"]."</td>
		                                			<td class='cell100 column5'>".$row["RegStatus"]."</td>
