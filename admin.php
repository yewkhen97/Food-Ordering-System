...
<body>
 ...
 <a href="admin_OrderReport.php">•Order Report</a></li><br>
  <a href="admin_SalesReport.php">•Restaurant Sales Report</a></li><br>
  <a href="Admin_DespatcherSalesReport.php">•Despatcher Sales Report</a></li><br>
  <a href="admin_ApproveRes.php">•Approve Restaurant</a></li><br>
  <a href="D_edit.php">•Approve Despatcher</a></li><br>
  <a href="D_Fdisplay.php">•Feedback Display</a></li>
                </div>
            </div>
        </div>
