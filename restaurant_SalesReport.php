...
?>
 ...
 $query = "SELECT orderdetail.OrderID,item.itemName, COUNT(orderdetail.ItemID) as number FROM orderdetail JOIN restaurant ON restaurant.ResID=orderdetail.ResID JOIN item ON orderdetail.ItemID=item.ItemID WHERE orderdetail.ResID='".$user['ResID']."' GROUP BY orderdetail.ItemID";  
 ...
 <!-- Required meta tags-->
    ...
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Restaurant Sales',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
        ...
        <div class="slider__area slider--one">
            ...
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Percentage of Restaurant Sales Report</h2>
                </div>
                <div class="card-body">
