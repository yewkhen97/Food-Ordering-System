...
<tr><th>Restaurant ID</th><th>Name</th><th>Registration Status</th></tr>
                    <?php
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
       echo "<form action=restaurant_approved.php method=post>";
        echo "<tr><td>".$row['ResID']."</td><td>".$row['Name']."</td><td><select>
